...
import graphics.StippleView;
import graphics.DotView;
import graphics.GlobeView;
...
//		else if (source.getText().equals("Exclude White"))
//		{
//			Stippler.excludeWhite = !Stippler.excludeWhite;
//		}
	}
