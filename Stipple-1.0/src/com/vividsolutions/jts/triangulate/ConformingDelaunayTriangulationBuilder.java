...
public class ConformingDelaunayTriangulationBuilder 
{
	...
	private void create()
	{
		...
		//Envelope 
		siteEnv = DelaunayTriangulationBuilder.envelope(siteCoords);
	...
	public Geometry getVoronoiDiagram(GeometryFactory geomFact)
	{
		...
		return VoronoiDiagramBuilder.clipGeometryCollection(polys, siteEnv);
	}

	/**
	 * @param geomFact
	 * @return List of voronoi cell polygons.
	 */
	@SuppressWarnings("unchecked")
	public List<Polygon> getVoronoiPolygons(GeometryFactory geomFact)
	{
		create();
		return subdiv.getVoronoiCellPolygons(geomFact);
	}
}
